...
// A rectangular surface filled with instances of Element 2, each with a different size,
// speed, and direction. Display the intersections by drawing a circle at each point of
// contact. Set the size of one circle to be relative to the distance between the
// centers of the overlapping Elements and make the other circle tiny. Draw the smallest
// possible circle as white and largest as black, with varying grays representing
// sizes in between.
